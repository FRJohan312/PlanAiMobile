...
async def startup_event():
    ...
    # Inicializar agente con LangChain
...
async def chat(request: ChatRequest):
    ...
    try:
        ...
        # Incluir nombres específicos de plantas comunes
        plant_keywords = [
            'planta', 'flor', 'hoja', 'jardín', 'verde', 'semilla', 'raíz', 'tallo',
            'aloe', 'vera', 'cactus', 'suculenta', 'orquidea', 'helecho', 'bonsai',
            'rosa', 'tulipan', 'geranio', 'lavanda', 'jazmin', 'violeta', 'lirio',
            'monstera', 'pothos', 'ficus', 'bambú', 'bambu', 'palma', 'yuca',
            'peperomia', 'filodendro', 'anthurio', 'calathea', 'sansevieria',
            'tomate', 'lechuga', 'albahaca', 'menta', 'hierbabuena', 'cilantro',
            'arbol', 'árbol', 'arbusto', 'hierba', 'vegetal', 'hortaliza',
            'cultivo', 'siembra', 'cosecha', 'huerto', 'jardinería', 'jardineria',
            'botanica', 'botánica', 'fotosintesis', 'fotosíntesis', 'clorofila'
        ]
